...
| **phase2/**    | **Stubs only** — `readme_client.py`, `readme_signals.py`, `scan_integration.py`: module docstrings list tasks for Phase 2 (you implement). See **`docs/TASKS_PHASE2.md`**.                                                                              |
